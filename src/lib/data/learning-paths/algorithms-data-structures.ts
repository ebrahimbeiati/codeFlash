...
export const algorithmsDataStructures: LearningPath = {
  ...
  sets: [
    {
      ...
      cards: [
        ...
        },
        {
          ...
          back: 'A priority queue is a data structure where elements are removed based on priority rather than insertion order. Typically implemented using heaps, providing O(log n) insertion and O(1) removal.',
          category: 'data-structures',
          difficulty: 'easy',
          reviewCount: 0,
          correctCount: 0
  ...
  quiz: {
    questions: [
      ...
      },
      {
        ...
        options: ['Stack', 'Linked List', 'Tree', 'Hash Table'],
        correctAnswer: 1
      },
      {
        id: 'q12',
      ...
      },
      {
        ...
        options: ['Array', 'Linked List', 'Set', 'Stack'],
        correctAnswer: 2
      },
      {
        id: 'q16',
      ...
      },
      {
        ...
        options: ['Quick Sort', 'Dijkstra\'s', 'Merge Sort', 'Binary Search'],
        correctAnswer: 1
      },
      {
        id: 'q28',
      ...
      },
      {
        ...
        options: ['Array', 'Hash Table', 'Tree', 'Graph'],
        correctAnswer: 0
      },
      {
        id: 'q30',
      ...
      },
      {
        ...
        options: ['O(1)', 'O(log n)', 'O(n)', 'Nearly constant'],
        correctAnswer: 3
      },
      {
        id: 'q33',
      ...
      },
      {
        ...
        options: ['KMP', 'Quick Sort', 'Dijkstra\'s', 'Merge Sort'],
        correctAnswer: 0
      }
    ]
  }
